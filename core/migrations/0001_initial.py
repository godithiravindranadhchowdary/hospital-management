# Generated by Django 4.2.28 on 2026-02-25 03:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dosage', models.CharField(help_text='Dosage instructions', max_length=200)),
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='prescriptions', to='core.doctor')),
            ],
            options={
